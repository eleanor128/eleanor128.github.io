...
const projects: Project[] = [
  {
    ...
    description: "An interactive virtual drum using Raspberry Pi sensors to deliver real-time 3D visuals and audio.",    
    ...
    description: "A real-time dashboard tracking marathon performance and demographics to empower data-driven business decisions.",    
  ...
  },
  {
    ...
    description: "A machine learning project evaluating multiple classification models and feature engineering methods to achieve a peak 86% accuracy.",    
