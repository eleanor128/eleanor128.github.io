...
const projects: Project[] = [
  {
    ...
    description: "An interactive virtual drum built with Raspberry Pi and motion sensors to track real-time motion. It renders 3D drumming animations on screen while triggering synchronized sound output for an immersive experience.",
    ...
    description: "An interactive real-time dashboard that visualizes runner performance and demographic trends, supporting strategic decision-making and business negotiations.",
